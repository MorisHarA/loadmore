...
var LoadMore = (_dec = Bind(), _dec2 = Throttle(100), (_class = function (_React$Component) {
  ...
  function LoadMore() {
    ...
    return _possibleConstructorReturn(this, (LoadMore.__proto__ || _Object$getPrototypeOf(LoadMore)).apply(this, arguments));
  }
  ...
  _createClass(LoadMore, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(
          'div',
          { className: styles.loading, ref: function ref(el) {
              _this2.el = el;
            } },
          loading && React.createElement('img', { className: styles.gif, src: gif, alt: 'loading' }),
          !loading && completed && React.createElement(
            'span',
            null,
            '\u6CA1\u6709\u4E86\uFF0C\u5230\u5E95\u4E86\uFF01'
          )
